...
const projectsData: Project[] = [
  {
    title: 'NextMesa',
    description: 'NextMesa é um sistema web criado para gestão de mesas e atendimentos em restaurantes e bares. ',
    image: 'https://images.pexels.com/photos/5076516/pexels-photo-5076516.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2',
    technologies: ['React', 'Node.js', 'Postgres', 'NextJs', 'TypeScript'],
